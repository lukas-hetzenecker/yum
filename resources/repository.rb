...
#########
# TODO: finish sanity checking.
#########

# http://linux.die.net/man/5/yum.conf
attribute :baseurl, kind_of: String, regex: /.*/ , default: nil
attribute :cost, kind_of: Integer, regex: /\d+/, default: nil
...
attribute :failovermethod, kind_of: String, equal_to: ['priority','roundrobin'], default: nil
attribute :gpgcheck, kind_of: [TrueClass,FalseClass], default: true
attribute :gpgkey, kind_of: String, regex: /.*/, default: nil
attribute :http_caching, kind_of: String, equal_to: ['packages','all','none'], default: nil
...
attribute :metadata_expire, kind_of: [Integer, String], default: nil # time in seconds, or string 'never'
attribute :mirrorlist, kind_of: String, regex: /.*/, default: nil
attribute :priority, kind_of: [Integer, String], default: nil # 1-99
...
attribute :timeout, kind_of: [Integer,String], regex: /.*/, default: nil
